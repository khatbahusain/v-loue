...
class PrivateMessageDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    senderMP: Field::BelongsTo.with_options(class_name: "User"),
    recipientMP: Field::BelongsTo.with_options(class_name: "User"),
    id: Field::Number,
    recipientMP_id: Field::Number,
    senderMP_id: Field::Number,
